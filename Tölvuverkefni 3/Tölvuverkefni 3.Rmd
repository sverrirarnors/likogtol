...
$$H_0: \mu_1=\mu_2$$ Þar sem $\mu_0$ er meðallengd á fyrra hafsvæðinu og $\mu_1$ meðallengd á seinna hafsvæðinu.
...
tr<-data.frame(x=x, y=y, label=as.character(reitir))
  ggplot(data=island,aes()) + geom_sf(color="blue")+ geom_point(data = tr, aes(x,y,label=label),color="red")+geom_label(data = tr, aes(x,y,label=label))
